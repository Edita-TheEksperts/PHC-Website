...
function MyApp({ Component, pageProps }) {
  ...
  const excludedPages = ['/old-index', '/Registrierung-Jobs', '/Registrierung','/Registrierung-Form1','/Registrierung-Form2','/Registrierung-Jobs-Form1','/Registrierung-Jobs-Form2'];
