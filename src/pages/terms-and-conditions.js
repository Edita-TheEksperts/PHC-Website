    ...
    return (
      <div className="flex flex-col items-center bg-[#FAFCFF] min-h-screen py-10 px-4">
        ...
        <div className="flex flex-col items-start w-full max-w-[920px] mt-[80px] mb-[80px]">
          ...
          {/* Section: Kontaktadresse */}
          <h2 className="text-[#04436F] font-bold text-[26px] md:text-[36px] leading-[30px] md:leading-[43.2px] mb-[20px]">
            Kontaktadresse
          </h2>
          ...
          <p className="text-[#04436F] text-[18px] md:text-[24px] font-normal leading-[26px] md:leading-[43.2px] mb-[20px]">
            CHE-215.205.279
          </p>
          ...
          <p className="text-[#04436F] text-[18px] md:text-[24px] font-normal leading-[26px] md:leading-[43.2px] mt-10">
